    ...
    <div class="gradient-color main-go">
      <section class="main-page">
        <div class="center-block go-center">
          <h1>Go PRO ⚡️ </h1>
          <h2>{{ $t('goProH2One') }} <span class="color-green">TBCC Wallet PRO</span></h2>
        </div>
      </section>
      <section>
        <div class="center-block">
          <div class="two-block mobile-column-reverse">
            ...
            <div class="column aos-init aos-animate" data-aos="fade-up">
              <div class="text go-text">
                <h2 class="go-caption">{{ $t('goProH2Two') }}</h2>
                <p class="go-p">{{ $t('goProPOne') }}</p>
          ...
          <div class="two-block">
            <div class="column">
              <div class="text go-text">
                <h2 class="go-caption" style="white-space: nowrap">{{ $t('goProH2Three') }}</h2>
                <p class="go-p">
                  {{ $t('goProPTwo') }}
                </p>
                <a href="https://www.binance.org/en/trade/mini/TBCC-BA1M_BNB"
    ...
    <section>
      <div class="two-block">
        ...
        <div class="column w-40">
          <div class="text go-text">
            <h2 class="go-caption" style="color: #070E1E; font-weight: bold">{{ $t('goProH2Four') }}</h2>
            <p class="go-p" style="color: #535353;">{{ $t('goProPThree') }}</p>
            <a href="https://www.binance.org/en/trade/mini/TBCC-BA1M_BNB"
               class="m-btn mt-5" style="min-width: 230px; font-weight: bold">
              {{ $t('getButton') }}
              <i>.apk</i>
      ...
      <div class="two-block">
        <div class="column">
          <div class="text go-text">
            <h2 class="go-caption" style="color: #070E1E; font-weight: bold">{{ $t('goProH2Five') }}</h2>
            <p class="go-p" style="color: #535353;">{{ $t('goProPFour') }}</p>
            <a href="https://www.binance.org/en/trade/mini/TBCC-BA1M_BNB"
               class="m-btn mt-5" style="min-width: 230px; font-weight: bold">
              {{ $t('getButton') }}
              <i>.apk</i>
